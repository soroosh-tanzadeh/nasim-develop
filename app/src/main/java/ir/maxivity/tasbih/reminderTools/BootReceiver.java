...
public class BootReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        for (Reminder reminder : azanReminders) {
            ...
            if (reminder.getTitle().equals(context.getString(R.string.azan_fajr))) {
                ...
                Time maghrib = getAzanTimes(context).maghrib();
                maghrib.setMinute(maghrib.getMinute() + 17);
                reciever.setAlarm(context, setAzanTime(today, maghrib), reminder.getID());
    ...
    private AzanTimes getAzanTimes(Context context) {
        ...
        Azan azan = new Azan(location, tehranGeophysics);
