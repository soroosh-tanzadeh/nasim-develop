...
public class LocationInfoFragment extends Fragment {
    ...
    private ImageView arrow, locationImage, favoritePlaceIcon;
    ...
    public static LocationInfoFragment newInstance(GetPlaces.response model, GetEventResponse eventResponse, String userId) {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            this.userId = getArguments().getString(USERID_KEY);
    ...
    private void initViews(View view) {
        ...
        favoritePlaceIcon = view.findViewById(R.id.favorite_place_icon);
        ...
        if (model.isFavorite == 0) {
            favoritePlaceIcon.setImageResource(R.drawable.ic_bookmark_blue);
        } else {
            favoritePlaceIcon.setImageResource(R.drawable.ic_bookmark);
        }
    ...
    private void viewActions() {
        ...
        webSiteWrapper.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(getContext(), "آدرس سایت معتبر نیست", Toast.LENGTH_SHORT).show();
                }
        ...
        addFavoritePlaceWrapper.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                listener.onFavoritePlaceClick(model.id, status);
            }
        });
